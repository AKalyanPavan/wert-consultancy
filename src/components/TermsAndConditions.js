		...
		<>
			...
			<div className="bg-[#f8f8f8] py-[50px] px-[20px] sm:px-[50px] font-['Lexend']">
				<div className="max-w-[1000px] bg-white mx-auto shadow-xl rounded-[10px] py-[20px] px-[20px] sm:px-[30px] font-normal text-[#4e4e4e] leading-[30px]">
					...
					<p className="mb-[10px]">
					    Please carefully review the following terms and conditions, as your use of our services is contingent upon your acceptance and adherence to these terms (“Terms”).
					</p>
					<p className="mb-[10px]">
					...
					<ul className="list-disc pl-[30px] sm:pl-[50px]">
					    <li>Republishing any content from this website, including on other websites, is prohibited.</li>
					    <li>Material from the website may not be sold, rented, or sub-licensed.</li>
					    <li>Displaying any content from the website in public without prior authorization is not allowed.</li>
					    <li>Reproducing, duplicating, copying, or otherwise utilizing website content for commercial purposes or any purpose beyond its intended use of learning and teaching, as specified on the website, is strictly prohibited.</li>
					    <li>Editing or modifying any content on the website without permission is not permitted.</li>
					</ul>
					...
					<ul className="list-disc pl-[30px] sm:pl-[50px]">
					    <li>
					        You agree to provide and maintain accurate, up-to-date, and truthful information about yourself as required during registration. You must not impersonate any individual or misrepresent your identity, including using another person’s username, password, email address, or name. Additionally, you agree to promptly inform us of any unauthorized use of your account or security breaches that come to your attention. You are responsible for safeguarding your account credentials and acknowledge that you are accountable for all activities, content, and transactions associated with your account.
					    </li>
					    <li>
					        Failure to adhere to these terms and conditions may result in the suspension or termination of your account, with or without prior notice.
					    </li>
					</ul>
					...
					<ul className="list-disc pl-[30px] sm:pl-[50px]">
					    <li>
					        You must not use this website in a manner that causes or may cause damage to the website, disrupts its availability or accessibility, or engages in any unlawful, fraudulent, harmful, or illegal activity.
					    </li>
					    <li>
					...
					<p>
					    If any provision of these terms and conditions is deemed unlawful or unenforceable by a court or other competent authority, the remaining provisions shall remain in full effect. If modifying or removing a portion of the provision would make it lawful and enforceable, that portion shall be considered removed, while the rest of the provision remains valid.
					</p>
					...
					<p>
					    In the event of any conflict between these website terms and conditions and other applicable terms, policies, or notices, the specific terms related to a particular section or module of the website shall take precedence for your use of that section or module.
					</p>
					...
					<p>
					    These terms and conditions are governed by and interpreted in accordance with the laws of India. Any disputes arising from these terms shall fall under the exclusive jurisdiction of the Indian courts. In case of disputes, resolution will be conducted as per the provisions of the Arbitration and Conciliation Act, 1996 of India.
					</p>
					...
					<p>
					    If you have any questions, feedback, or concerns regarding the website, privacy policy, or any other terms, policies, or notices, including how we manage your personal information, please feel free to contact us.
					</p>
